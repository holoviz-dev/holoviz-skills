...
You can also click the **Copy Markdown** icon at the top of each skill page to paste a skill directly into any AI chat. Claude Desktop / Cowork users can install all skills at once via the [pre-built plugin](https://github.com/holoviz-dev/holoviz-skills/releases/latest/download/holoviz-skills.plugin).
